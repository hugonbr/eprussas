...
urlpatterns = [
    ...
    path('dados_paciente/', views.dados_paciente_listar,
    ...
    path('plano_alimentar_listar/', views.plano_alimentar_listar,
         name="plano_alimentar_listar"),
    path('plano_alimentar/<str:id>/',
         views.plano_alimentar, name="plano_alimentar"),
