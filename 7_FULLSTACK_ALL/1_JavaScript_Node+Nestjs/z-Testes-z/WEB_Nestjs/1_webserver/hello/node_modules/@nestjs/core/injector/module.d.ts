...
export declare type InstanceToken = string | symbol | Type<any> | Abstract<any> | Function;
export declare class Module {
    ...
    addInjectable<T extends Injectable>(injectable: Provider, host?: Type<T>): string | symbol | Function | Type<any> | Abstract<any>;
    addProvider(provider: Provider): string | symbol | Function;
    isCustomProvider(provider: Provider): provider is ClassProvider | FactoryProvider | ValueProvider | ExistingProvider;
    addCustomProvider(provider: ClassProvider | FactoryProvider | ValueProvider | ExistingProvider, collection: Map<Function | string | symbol, any>): string | symbol | Function | Type<any> | Abstract<any>;
    ...
    addExportedProvider(provider: Provider | string | symbol | DynamicModule): Set<InstanceToken>;
    addCustomExportedProvider(provider: FactoryProvider | ValueProvider | ClassProvider | ExistingProvider): Set<InstanceToken>;
    validateExportedProvider(token: InstanceToken): InstanceToken;
