...
function entrar() {
  ...
  if (login == "" || senha == "") {
    document.getElementById("aviso").innerHTML = '<span class="alert alert-warning text-center">Campo(s) Vazio(s).</span>';
  ...
  // }
      ...
      document.getElementById("aviso").innerHTML = '<span class="alert alert-success text-center">Bem-vindo!</span>';
    } else {
      //alert("login ou senha incorretos!!! Tente novamente.");
      document.getElementById("aviso").innerHTML = '<span class="alert alert-danger text-center">login ou senha incorretos!</span>';
